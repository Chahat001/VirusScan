<?php
    ...
    if(isset($_POST['email']) && isset($_POST['password']) && isset($_POST['username'])){
        ...
        $stmt = $connection->prepare('SELECT * FROM userinfo WHERE username=? AND useremail=?');
        ...
        <!DOCTYPE html><html><head><title>An Example Form</title><style>.signup {border:1px solid #999999; font: normal 14px helvetica; color: #444444;}
            ...
            <body><table border="0" cellpadding="2" cellspacing="5" bgcolor="#eeeeee"><th colspan="2" align="center">Login Form</th><form method="post" action="login_page.php" onsubmit="return validate(this)">
                ...
                <tr><td colspan="2" align="center"><a href=signup.php> Sign Up </a> </td></tr>
            </form></table>
            </body>
            </html>
        _END;
